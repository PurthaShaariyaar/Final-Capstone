...
const getTeamData = (teamName) => {
    ...
    const numericColumns = ['points_scored', 'points_scored_opp', 'yards_gained', 'yards_gained_opp',
...
const predictGameOutcome = (team1Name, team2Name) => {
    ...
    const featuresTeam1 = ['points_scored', 'points_scored_opp', 'yards_gained', 'yards_gained_opp',
                            'turnovers', 'turnovers_opp', 'turnovers_opp', 'yards_gained', 'player_weight'].map(col => team1Data[col]);
    const featuresTeam2 = ['points_scored', 'points_scored_opp', 'yards_gained', 'yards_gained_opp',
                            'turnovers', 'turnovers_opp', 'turnovers_opp', 'yards_gained', 'player_weight'].map(col => team2Data[col]);
